...
const SIDEBAR_WIDTH_ICON = "3.5rem" // Increased for centering
  ...
  (
    ...
    return (
      <div
        ...
        data-side={side}
        className={cn(
          "group/sidebar peer hidden h-svh bg-sidebar text-sidebar-foreground transition-[width] duration-200 md:flex md:flex-col",
  ...
  return (
    <main
      ...
      className={cn(
        ...
        "peer-data-[variant=inset]:ml-0 peer-data-[variant=inset]:md:ml-[var(--sidebar-width)]",
        "peer-data-[variant=inset]:peer-data-[state=collapsed]:md:ml-[var(--sidebar-width-icon)]",
        className
      )}
      {...props}
    />
